...
#
# Usage:
#   bash scripts/run_strengthening_v2_race.sh           # run all
#   bash scripts/run_strengthening_v2_race.sh expD      # AdaMix-Raw only
#   bash scripts/run_strengthening_v2_race.sh expF      # K=1,2 only
#   bash scripts/run_strengthening_v2_race.sh expA      # Noise robustness only
