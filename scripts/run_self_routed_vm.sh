#!/usr/bin/env bash
# Self-Routed MoA (SR-MoA) experiment sweep on GPU VM.
#
# Three priorities:
...
#
# Usage:
#   bash scripts/run_self_routed_vm.sh                  # run all
#   bash scripts/run_self_routed_vm.sh worker 1 4       # worker 1 of 4
set -e
