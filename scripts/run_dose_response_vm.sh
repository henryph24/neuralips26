...
#
# Invocation:
#   bash scripts/run_dose_response_vm.sh                  # single worker
#   bash scripts/run_dose_response_vm.sh worker K N       # worker K of N
#
# Launch 4 workers in parallel via tmux:
#   tmux new-session -d -s dr_w1 'cd ~/neuralips26 && bash scripts/run_dose_response_vm.sh worker 1 4 2>&1 | tee -a results/dr_w1.log'
#   tmux new-session -d -s dr_w2 'cd ~/neuralips26 && bash scripts/run_dose_response_vm.sh worker 2 4 2>&1 | tee -a results/dr_w2.log'
#   tmux new-session -d -s dr_w3 'cd ~/neuralips26 && bash scripts/run_dose_response_vm.sh worker 3 4 2>&1 | tee -a results/dr_w3.log'
#   tmux new-session -d -s dr_w4 'cd ~/neuralips26 && bash scripts/run_dose_response_vm.sh worker 4 4 2>&1 | tee -a results/dr_w4.log'
