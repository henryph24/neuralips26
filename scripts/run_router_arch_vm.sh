...
#
# Invocation:
#   tmux new-session -d -s rarch 'cd ~/neuralips26 && bash scripts/run_router_arch_vm.sh 2>&1 | tee results/rarch.log'
#
# Worker sharding: bash scripts/run_router_arch_vm.sh worker 1 2
