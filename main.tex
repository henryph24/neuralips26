...
\item \textbf{Consistent empirical improvement}: evolved adapters beat hand-designed baselines on \textbf{all 17 experiments} across 5 datasets (ETTh1, ETTh2, ETTm1, ETTm2, Weather), 3 random seeds, 2 forecast horizons, and 4 TSFM backbones (MOMENT-small, MOMENT-large, Chronos, Moirai), with an average improvement of 11.1\%.
