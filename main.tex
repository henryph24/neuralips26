...
\item \textbf{Search space characterization.} We prove that the quality fraction $f \approx 0.03{-}0.05$ of the template grammar outperforms standard adapters, making $B{\geq}60$ random samples sufficient for ${\geq}95\%$ success (\S\ref{sec:decomposition}). Zero-cost gradient-norm proxies further reduce search cost to ${\sim}300$ms on compatible datasets ($\rho{=}0.905$ on Electricity).
\end{enumerate}
