...
**Longer horizons (>720).** [NEW] At H∈{1000,2000}, routing stays healthy (entropy 1.03-1.54, no collapse, not more diverse) and RR-MoA still beats the best fixed adapter at every cell (21-72%). So representations and routing do not become limiting even at H=2000.
